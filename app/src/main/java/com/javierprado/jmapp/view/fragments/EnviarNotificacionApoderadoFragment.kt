...
class EnviarNotificacionApoderadoFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_enviar_notificacion_apoderado, container,
            false)
...
//        cambiareditEtxt = view.findViewById(R.id.edit_txt)
    ...
    companion object {
        ...
        fun newInstance(token: String) =
            EnviarNotificacionApoderadoFragment().apply {
