...
class CursoUtil {
    companion object {
        ...
        private val i1 = Color.parseColor("#E7BB41") ; private val i2 = Color.parseColor("#f2fbff")
        ...
        fun getBackgroundColor(curso: String): Int { return backCs[curso[0].toString().lowercase()]!! }
